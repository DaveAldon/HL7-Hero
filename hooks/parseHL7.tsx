export function parseHL7(raw: string) {
  let hl7 = raw;
  let separators = ["MSH", "DG1", "DRG", "FT1", "OBR", "EVN", "PID", "PV1", "GT1", "IN1", "IN2", "OBX", "PR1", "TXA", "ORC"];
  let master: any[] = [];
  ...
  let tokens = hl7.split(new RegExp("(" + separators.join("\\||") + "\\|)"));
  ...
  master.forEach((value, index) => {
    ...
    for (let i = 0; i < fields.length; i++) {
      ...
      try {
        ...
        //MasterSegments[segmentName][`${segmentName}-${i + 1}`] = subDetail;
        MasterSegments[segmentName].push(subDetail);
      } catch (e) {}
    }
  });
